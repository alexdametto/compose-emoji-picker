...
import dev.alexdametto.compose_emojis.di.ViewModelModule
import dev.alexdametto.compose_emojis.domain.model.EMOJI_GRINNING_FACE
...
fun EmojiBottomSheet(
    open: Boolean,
    onClose: () -> Unit,
    viewModel: EmojiBottomSheetViewModel = EmojiBottomSheetViewModel(
